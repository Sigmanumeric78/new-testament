  ...
  if (!detail) {
    return (
      <section className="rounded-2xl border border-dashed border-slate-300 bg-slate-50 p-6 text-sm text-slate-600">
        Select a compound or ingredient signal to view details.
      </section>
    )
  }
  ...
  return (
    <section className="space-y-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
      <div className="flex flex-wrap items-start justify-between gap-3">
        <div>
          <p className="text-xs font-semibold uppercase text-brand-700">Compound profile</p>
          <h3 className="text-xl font-semibold text-slate-900">{detail.compound_name}</h3>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
          <p className="text-xs font-semibold uppercase text-slate-500">Structure data</p>
          <p className="mt-1 text-xs font-semibold text-slate-600">Canonical SMILES</p>
          <p className="mt-1 break-all font-mono text-xs text-slate-800">{detail.canonical_smiles || 'Unavailable'}</p>
        </div>
        <div className="rounded-xl border border-slate-200 bg-slate-50 p-3">
          <p className="text-xs font-semibold uppercase text-slate-500">Found in</p>
      ...
      <div className="grid gap-3 md:grid-cols-2">
        <div className="rounded-xl border border-slate-200 p-3">
          <p className="text-xs font-semibold uppercase text-slate-500">Possible relevance</p>
          <p className="mt-1 text-xs font-semibold text-slate-600">Metabolism</p>
        ...
        <div className="rounded-xl border border-slate-200 p-3">
          ...
          <p className="mt-1 text-xs font-semibold text-slate-600">Risk relevance</p>
      ...
      <div className="space-y-2">
        <p className="text-xs font-semibold uppercase text-slate-500">Structure data, if available</p>

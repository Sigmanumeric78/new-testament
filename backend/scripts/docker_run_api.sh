...
RUN_ARGS=(
  ...
  -e "ARTIFACT_STORE_BACKEND=${ARTIFACT_STORE_BACKEND:-mongodb}"
  -e "VECTOR_BACKEND=${VECTOR_BACKEND:-pinecone}"
  -e "PINECONE_INDEX=${PINECONE_INDEX:-healthlens-knowledge}"
  -e "PINECONE_NAMESPACE=${PINECONE_NAMESPACE:-production}"
  -e "PINECONE_DIMENSION=${PINECONE_DIMENSION:-768}"
  -e "PINECONE_METRIC=${PINECONE_METRIC:-cosine}"
